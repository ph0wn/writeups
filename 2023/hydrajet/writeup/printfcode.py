#-------------------------------------------------------------------------------
# Name:        Hydrajet exploit (printfcode)
# Purpose:     Solution for ph0wn's challenge Hydrajet level 1 and 2
#              calling-back deadcode with printf('flag') already present
#
# Author:      Phil
#
# Created:     29/10/2023
...
# Pins on hydrajet for the usart1 connection: PA10 = RX, PA9 = TX
...
def main():
    ...
    exploit = open("printfcode.bin", "rb").read()
    time.sleep(0.1)
    ...
    while True:
        print(str(serManagement.read(),'UTF-8'),end='')
