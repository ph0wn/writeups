        ...
        for fname in sorted(os.listdir(FOOD_DIR)):
            ...
            if os.path.isfile(full_path):
                try:
                    ...
                    # Intentionally resolve user-provided paths from FOOD_DIR.
                    # This preserves the path traversal challenge while avoiding
                    # accidental resolution from the process working directory.
