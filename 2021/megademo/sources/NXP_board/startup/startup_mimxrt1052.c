...
void (* const g_pfnVectors[])(void) = {
	...
	NVIC_SystemReset,//NMI_Handler,                       // The NMI handler
	NVIC_SystemReset,//HardFault_Handler,                 // The hard fault handler
	NVIC_SystemReset,//MemManage_Handler,                 // The MPU fault handler
	NVIC_SystemReset,//BusFault_Handler,                  // The bus fault handler
	NVIC_SystemReset,//UsageFault_Handler,                // The usage fault handler
    0,                                 // Reserved
    0,                                 // Reserved
    0,                                 // Reserved
    0,                                 // Reserved
